...
public class WorldProviderAsteroid extends WorldProvider {
	...
	protected void registerWorldChunkManager()
    {
		...
		worldChunkMgr = new WorldChunkManagerHell(biome,0,0);
...
class BiomeAsteroidDecorator extends BiomeDecorator
{
    ...
    public BiomeAsteroidDecorator(BiomeGenBase par1BiomeGenBase)
    {
        ...
        oreCopperGen = new WorldGenMinable(ModMinestation.blockAsteroid.blockID,1,20,ModMinestation.blockAsteroid.blockID);
        oreIronGen = new WorldGenMinable(ModMinestation.blockAsteroid.blockID,2,20,ModMinestation.blockAsteroid.blockID);
        
        orePlasmaGen = new WorldGenMinable(ModMinestation.blockAsteroid.blockID,3,15,ModMinestation.blockAsteroid.blockID);
        oreSilverGen = new WorldGenMinable(ModMinestation.blockAsteroid.blockID,4,15,ModMinestation.blockAsteroid.blockID);
        oreGoldGen = new WorldGenMinable(ModMinestation.blockAsteroid.blockID,5,15,ModMinestation.blockAsteroid.blockID);
        
        oreUraniumGen = new WorldGenMinable(ModMinestation.blockAsteroid.blockID,6,10,ModMinestation.blockAsteroid.blockID);
        oreDiamondGen = new WorldGenMinable(ModMinestation.blockAsteroid.blockID,7,10,ModMinestation.blockAsteroid.blockID);
        
        oreBananaGen = new WorldGenMinable(ModMinestation.blockAsteroid.blockID,8,5,ModMinestation.blockAsteroid.blockID);
    }
